                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <input type="text" name="kiku_exclude_category_frontpage" class="regular-text" value="<?= get_option('kiku_exclude_category_frontpage'); ?>" id="kiku_exclude_category_frontpage" />
                        </label>
                    </td>
                </tr>
            </tbody>
