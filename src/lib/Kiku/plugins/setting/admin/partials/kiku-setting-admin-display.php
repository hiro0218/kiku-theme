                ...
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <textarea name="kiku_insert_data_head" rows="4" wrap="off" style="width:100%;"><?= get_option('kiku_insert_data_head'); ?></textarea>
                        </label>
                    </td>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label>
                            ...
                            <textarea name="kiku_insert_data_bottom_of_content" rows="4" wrap="off" style="width:100%;"><?= get_option('kiku_insert_data_bottom_of_content'); ?></textarea>
                        </label>
                    </td>
                </tr>
            </tbody>
